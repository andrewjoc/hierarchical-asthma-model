...
$$\beta_0, \beta_1, \beta_2 \sim \text{Uniform}(-\infty, \infty) \\ \theta_i \sim \sigma(\beta_0 + \beta_1 P_i+\beta_2 O_i) \\ X_i \sim \text{Binomial}(A_i, \theta_i)$$
...
<figure style="text-align: center;">
  <img src="./figures/graphical_model.png" alt="Graphical model of the Bayesian Hierarchical Model" width="60%" />
  <figcaption>Figure 1. Graphical model of hypothesized relationship between air pollutants and county ED visits.</figcaption>
</figure>
...
<figure style="text-align: center;">
  <img src="./figures/pymc_model.png" alt="Python implementation of the hierarchical model using PyMC" width="60%" />
  <figcaption>Figure 2. Python implementation of the hierarchical model using PyMC.</figcaption>
</figure>
...
<figure style="text-align: center;">
  <img src="./figures/coefficients.png" alt="Coefficients of the linear predictor in the hierarchical model" width="60%" />
  <figcaption>Figure 3. Coefficients of the linear predictors.</figcaption>
</figure>
...
<figure style="text-align: center;">
  <img src="./figures/random_parameters_convergence.png" alt="Check of the convergence in the Bayesian model" width="60%" />
  <figcaption>Figure 4. Distribution of Random Parameters in the Bayesian model.</figcaption>
</figure>
...
<figure style="text-align: center;">
  <img src="./figures/posterior_predictive_check.png" width="60%" />
  <figcaption>Figure 5. Plot of the posterior predictive check (PPC).</figcaption>
</figure>
...
<figure style="text-align: center;">
  <img src="./figures/rate_comparison.png" width="60%" />
  <figcaption>Figure 6. Scatter plot copmaring observed and estimated ED visit rates.</figcaption>
</figure>
